...
const features = [
  ...
  },
  {
    ...
    description: "Reliable reminder delivery powered by background workers.",
    icon: Mail,
    gradient: "from-violet-500 to-fuchsia-500",
  },
  {
    title: "Live Sync",
    description: "Contest data updates automatically every hour.",
    icon: Clock3,
  ...
  return (
    <section id="features" className="relative py-20">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <p className="font-semibold text-cyan-400">FEATURES</p>

          <h2 className="mt-4 text-5xl font-black">Everything You Need</h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-400">
            Built for competitive programmers with beautiful UI, reliable
            reminders and modern technology.
          </p>
        </motion.div>
...
function FeatureCard({ feature, index }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.04] backdrop-blur-xl p-7 transition
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div
          className={`mb-6 flex p-2 h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${feature.gradient}`}
        >
          <Icon size={28} />
        </div>
          ...
          <div className="mt-auto">
            ...
            <div className="mt-8 rounded-2xl border border-white/10 bg-slate-900/70 p-5">
              <div className="mb-5 flex items-center justify-between">
                <span className="font-semibold">Upcoming Contests</span>

                <Sparkles className="text-cyan-400" />
              </div>

              <div className="space-y-3">
                {["LeetCode Weekly", "Codeforces Round", "AtCoder ABC"].map(
                  (item) => (
                    <div
                      key={item}
                    ...
                    >
                      ...
                      <span className="text-xs text-cyan-400">Tomorrow</span>
                    </div>
                  ),
                )}
              </div>
